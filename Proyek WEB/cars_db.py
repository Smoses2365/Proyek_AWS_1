...
try:
    ...
    print("Database 'car_rental_dbs' berhasil dibuat.")
    ...
    """
    users_data = [
        ("Admin", "admin@carrental.com", admin_password_hashed, "08123456789", "admin"),
    ]

    cursor.executemany(insert_users_query, users_data)
    cnx.commit()
    print("Data pengguna berhasil dimasukkan ke tabel 'users'.")

    # Masukkan data mobil (hanya jika belum ada)
    insert_cars_query = """
    ...
    cars_data = [
        ...
        ("Mitsubishi Pajero", "Mitsubishi", 7, "20 liter", "4 koper besar", 800000.00, 2, "images/Mitsubishi pajero.png"),
